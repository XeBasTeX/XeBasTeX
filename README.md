...
🔬 Déconvolution parcimonieuse de pics ou de courbes par optimisation sur l'espace de mesures de Radon, avec un a priori sur la covariance. Application en imagerie biomédicale type SOFI (fluorescence, CEUS) ;
